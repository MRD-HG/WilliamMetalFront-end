...
const Sidebar = () => (
  <aside className="w-72 bg-white border-r h-screen sticky top-0">
    ...
    <nav className="p-2 space-y-1">
      ...
      <NavLink to="/clients" className={({isActive})=> isActive ? "block p-2 rounded bg-black text-white" : "block p-2 rounded hover:bg-gray-50"}>Clients</NavLink>
    </nav>
  </aside>
);
      ...
      <div className="flex-1">
        <header className="h-14 flex items-center justify-between px-6 bg-white border-b">
          ...
          <div className="flex items-center gap-4">
            <input placeholder="Search products, invoices..." className="px-3 py-1 border rounded bg-gray-50" />
